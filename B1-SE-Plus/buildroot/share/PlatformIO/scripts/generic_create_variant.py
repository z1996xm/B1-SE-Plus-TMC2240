...
if pioutil.is_pio_build():
	...
	if platform_name in [ "usb-host-msc", "usb-host-msc-cdc-msc", "usb-host-msc-cdc-msc-2", "usb-host-msc-cdc-msc-3",  "usb-host-msc-cdc-msc-4","tool-stm32duino", "biqu-bx-workaround", "main" ]:
